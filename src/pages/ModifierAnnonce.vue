        ...
        <ion-header>
            <ion-toolbar>
                <ion-buttons slot="start">
                    <ion-back-button default-href="/vendeur/dasbord"></ion-back-button>
                </ion-buttons>
                <ion-title>Modifier l'annonce</ion-title>
            </ion-toolbar>
        </ion-header>
        <ion-content>
...
export default defineComponent({
    ...
    methods: {
        ...
        async chargerAnnonce() {
            try {
                this.annonce = await AnnonceParId(this.id)
                console.log("Annonce à modifier: ", this.annonce)
            } catch (error) {
                console.log(error)
            }
        },
        async envoyerAnnonce() {
            ...
            try {
                ...
                /*    Object.keys(this.annonce).forEach(key => {
                   if(key){
                     formData.append(key, this.annonce[key]);
                   }
                }); */
                ...
                const response = await axios.put('http://localhost:3000/annonces', formData, {
                    headers: {
